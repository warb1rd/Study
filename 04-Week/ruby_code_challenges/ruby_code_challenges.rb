...
to the directory that holds this file and run the file with the ruby command.
...
#     print 'puts_last should return the last element in an array'
# end
...
example_hash = {
  javascript: 'language mainly used for client-side scripting',
...
#     print 'puts_key should return a list of all keys'
# end
...
Implement a method called merge which accepts two arrays that are sorted in ascending order
